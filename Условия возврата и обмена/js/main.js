$(document).ready(function(e){
    ...
    $('.product_categories .parent_category').on('click',function(e){
        e.preventDefault();
        var childCategories = $(this).parent().find('.sub_category_1');
        $(this).toggleClass('active');
        $('.product_categories .sub_category_1').not(childCategories).slideUp();
        childCategories.slideToggle();
    })
    $('.product_categories .parent_category').on('click',function(e){
        e.preventDefault();
        var childCategories = $(this).parent().find('.sub_category_2');
        $(this).toggleClass('active');
        $('.product_categories .sub_category_2').not(childCategories).slideUp();
        childCategories.slideToggle();
    })
